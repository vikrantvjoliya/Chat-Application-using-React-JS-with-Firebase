...
function SinglePost() {
    ...
    useEffect(() => {
		document.title = `${(post?.username +" "+ post?.caption)} | KluMedia`;
            ...
            <div className="singlePost">
                ...
                <div className="singlePostRight">
                    ...
                    <div className="postInteractionBar singlePostInteractionBar">
                        ...
                        {user ? ((user.displayName || user.email.split('@')[0]) === post.username ? (<i onClick={deletePost} className="fas fa-trash-alt postInteractionItem singlePostInteractionBar"></i> ) : (<></>)) : ( <></> )}
